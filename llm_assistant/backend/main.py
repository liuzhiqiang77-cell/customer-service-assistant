...
from cs_assistant import assistant, SkillsRAG
...
async def lifespan(app: FastAPI):
    ...
    print(f"📚 基于《关键时刻》(Moments of Truth) 理论")
    yield
    print("👋 关闭服务")
...
app = FastAPI(
    title="客户服务助手 API",
    description="基于《关键时刻》(Moments of Truth) 的智能客户服务助手",
    version="1.0.0",
    lifespan=lifespan
)
